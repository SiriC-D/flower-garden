...
import { Leaf, Image, RotateCcw, Sparkles, Circle, Droplet, RefreshCw, Users, Heart } from 'lucide-react';
...
export default function FlowerGarden() {
  ...
  // --- Realtime: new flowers planted by anyone appear instantly for everyone ---
  useEffect(() => {
